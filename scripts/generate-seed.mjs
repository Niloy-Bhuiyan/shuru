 ...
 *   - src/lib/data/seed.ts     (identical data for offline demo mode)
 ...
 * Identical to supabase/seed.sql. Powers offline DEMO MODE.
 */
...
console.log(`seed.sql: ${LISTINGS.length} opportunities, ${outcomes.length} outcomes, ${REPORTS.length} reports, ${MENTORS.length} mentors`);
